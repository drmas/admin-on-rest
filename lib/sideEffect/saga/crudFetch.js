            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 9:
                        ...
                        _context.next = 12;
                        return [(0, _effects.put)({ type: type + '_SUCCESS', payload: response, meta: meta })].concat((0, _toConsumableArray3.default)(successSideEffects(type, meta.resource, payload, response).map(function (a) {
                    ...
                    case 14:
                        ...
                        _context.next = 18;
                        return [(0, _effects.put)({ type: type + '_FAILURE', error: _context.t0.message ? _context.t0.message : _context.t0, meta: meta })].concat((0, _toConsumableArray3.default)(failureSideEffects(type, meta.resource, payload, _context.t0).map(function (a) {
                            return (0, _effects.put)(a);
