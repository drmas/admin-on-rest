...
var crudGetList = exports.crudGetList = function crudGetList(resource, pagination, sort, filter) {
    return {
        ...
        meta: { resource: resource, fetch: _types.GET_LIST, cancelPrevious: true }
    };
};
...
var crudCreate = exports.crudCreate = function crudCreate(resource, data, basePath) {
    return {
        type: CRUD_CREATE,
        payload: { data: data, basePath: basePath },
        meta: { resource: resource, fetch: _types.CREATE, cancelPrevious: true }
    };
};
...
var crudUpdate = exports.crudUpdate = function crudUpdate(resource, id, data, basePath) {
    return {
        type: CRUD_UPDATE,
        payload: { id: id, data: data, basePath: basePath },
        meta: { resource: resource, fetch: _types.UPDATE, cancelPrevious: true }
    };
};
...
var crudDelete = exports.crudDelete = function crudDelete(resource, id, basePath) {
    return {
        type: CRUD_DELETE,
        payload: { id: id, basePath: basePath },
        meta: { resource: resource, fetch: _types.DELETE, cancelPrevious: true }
    };
};
...
var crudGetMatching = exports.crudGetMatching = function crudGetMatching(reference, relatedTo, filter) {
    return {
        type: CRUD_GET_MATCHING,
        payload: { filter: filter },
        meta: { resource: reference, relatedTo: relatedTo, fetch: _types.GET_MATCHING, cancelPrevious: false }
    };
};
...
var crudGetManyReference = exports.crudGetManyReference = function crudGetManyReference(reference, target, id, relatedTo) {
    return {
        type: CRUD_GET_MANY_REFERENCE,
        payload: { target: target, id: id },
