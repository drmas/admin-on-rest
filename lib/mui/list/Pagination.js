        ...
        value: function renderPageNums() {
            ...
            return this.range().map(function (pageNum) {
                return pageNum === '.' ? _react2.default.createElement(
                    'span',
                    { key: pageNum, style: { padding: '1.2em' } },
                    '\u2026'
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                nbPages > 1 && _react2.default.createElement(
                    _Toolbar.ToolbarGroup,
                    null,
                    page > 1 && _react2.default.createElement(_FlatButton2.default, { primary: true, key: 'prev', label: lang && lang == "ar" ? "السابق" : "Prev", icon: _react2.default.createElement(_chevronLeft2.default, null), onClick: this.prevPage, style: buttonStyle }),
                    this.renderPageNums(),
                    page !== nbPages && _react2.default.createElement(_FlatButton2.default, { primary: true, key: 'next', label: lang && lang == "ar" ? "التالي" : "Next", icon: _react2.default.createElement(_chevronRight2.default, null), labelPosition: 'before', onClick: this.nextPage, style: buttonStyle })
                )
            );
        }
    }]);
