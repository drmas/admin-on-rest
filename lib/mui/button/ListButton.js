...
var ListButton = function ListButton(_ref) {
    ...
    return _react2.default.createElement(_FlatButton2.default, { primary: true, label: lang && lang == "ar" ? "القائمة الرئيسية" : "List", icon: _react2.default.createElement(_list2.default, null), containerElement: _react2.default.createElement(_reactRouter.Link, { to: basePath }) });
};
